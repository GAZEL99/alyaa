...
global.owner = ['6287763058955'] //['628','628'] 2 owner
global.packname = 'Bot WhatsApp'
global.author = 'Nazedev'
global.botname = 'Alyaa'
global.namaowner = 'Alya'
globar.delayjpm = '3000'
global.listprefix = ['+','!','.']
global.listv = ['•','●','■','✿','▲','➩','➢','➣','➤','✦','✧','△','❀','○','□','♤','♡','◇','♧','々','〆']
...
module.exports = {
  // ... (setting yang sudah ada)
  
  // [JPM Settings]
  jpmConfig: {
    delay: 4000, // Delay antar grup (ms)
    maxGroupsPerHour: 15, // Batasan grup/jam
    thumbnailPath: './media/thumbnail.jpg', // Path gambar thumbnail
    ownerNumber: '62812xxxxxx', // Nomor owner
    footerText: '© Powered by YourBot', // Teks footer
  },

  // Daftar grup yang diblacklist (tidak menerima JPM)
  blacklistJPM: [],
